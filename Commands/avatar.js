...
let larsy = new Discord.MessageEmbed()
...
message.channel.send(larsy)
  ...
  message.channel.send(new Discord.MessageEmbed().setColor("#323131").setDescription("User not found!"));
  return;
}
 ...
 exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['avatar',"pp", "profilephoto"],
  permLevel: 0
};
